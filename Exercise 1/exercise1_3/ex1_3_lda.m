...
title('LDA run on example dataset');
hold off
...
title('PCA run on example dataset');
hold off
...
title('Example Dataset of IRIS classes');
hold off
...
title('LDA applied on the example dataset');
hold off

[meas_recovered] = projectDataLDA(meas_norm, v);
subplot(1,2,2);
hold on
plot(meas_recovered(iris_labels==0, :), meas_recovered(iris_labels==0, :),'bo');
plot(meas_recovered(iris_labels==1, :), meas_recovered(iris_labels==1, :),'rs');
plot(meas_recovered(iris_labels==2, :), meas_recovered(iris_labels==2, :),'g+');
title('Recovered LDA dataset');
hold off
